...
//            jQuery('.rightpanel, .headerinner').css({ marginLeft: '220px' });
//            jQuery('.logo, .leftpanel').css({ marginLeft: 20 });
//        } else {
//            jQuery('.rightpanel, .headerinner').css({ marginLeft: 0 });
//            jQuery('.logo, .leftpanel').css({ marginLeft: '-220px' });
//        }
//    });
